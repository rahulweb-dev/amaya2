...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="relative h-screen min-h-[640px] overflow-hidden bg-navy-deep">
      <motion.div
        style={{ y: imageY }}
      ...
      >
        <div className="max-w-[1200px] mx-auto px-6 lg:px-16 w-full pb-0">
          <div className="max-w-xl pb-16 lg:pb-24">
            ...
            >
              Independent senior living by Vera Vita, designed around comfort, community, nature, and quiet reassurance.
            </motion.p>
          ...
          <div className="max-w-[1200px] mx-auto px-6 lg:px-16">
            <div className="grid grid-cols-2 lg:grid-cols-4">
              {stats.map((stat, i) => (
                ...
                >
                  <div className="font-serif text-3xl font-normal text-limestone/80">{stat.value}</div>
                  <div className="font-sans text-[16px] font-light text-stone/50 tracking-[0.04em] mt-0.5 leading-snug">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
